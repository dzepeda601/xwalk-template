...
## Environments
- Preview: https://main--xwalk-template--dzepeda601.aem.page/
- Live: https://main--xwalk-template--dzepeda601.aem.live/
...
1. Open the `xwalk-template` directory in your favorite IDE and start coding :)
